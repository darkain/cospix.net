<article class="cpn-default">
	<h1 class="cpn-header">
		<span class="smaller" style="float:right">Total: Total: [follow.#]</span>
		Following
	</h1>
	...
	<div class="cpn-default">
		...
		<ul class="cpn-account-list">
			<li>
				<a class="cpn-account-name" itemprop="follows" href="[afurl.base]/[follow.user_url;ifempty='[follow.user_id]';block=li]" data-id="[follow.user_id]">
