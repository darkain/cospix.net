...
[onshow;file=scroller.tpl;when [afurl.jq]!=1]
</style>

<article class="cpn-default">
<h1 class="cpn-header">COSPIX.NET TERMS OF SERVICE</h1>



<section class="cpn-default">
<p>Last Updated: DECEMBER 20TH, 2013</p>
<p>These terms of service ("Terms") apply to your access and use of Cospix.net (the "Service"). Please read them carefully.</p>
</section>
...
<p>Whenever we make changes to these Terms, the changes are effective 24 hours after we post such revised Terms (indicated by revising the date at the top of these Terms) or upon your acceptance if we provide a mechanism for your immediate acceptance of the revised Terms (such as a click-through confirmation or acceptance button). It is your responsibility to check Cospix.net for changes to these Terms.</p>
...
<p>For information about how we collect and use information about users of the Service, please check out our privacy policy available at <a href="[afurl.base]/legal/privacy">[afurl.host][afurl.base]/legal/privacy/</a>.</p>
</section>
...
<p>You may not post, link and otherwise make available on or through the Service any of the following:<ul>
...
<p>Also, you agree that you will not do any of the following in connection with the Service or other users:<ul>
...
<li>Circumvent or attempt to circumvent any filtering, security measures, rate limits or other features designed to protect the Service, users of the Service, or third parties.</li></ul></p>
</section>



<section class="cpn-default">
<h3>Cospix.net Materials</h3>
...
<p>Cospix.net makes no claim or representation regarding, and accepts no responsibility for third party websites accessible by hyperlink from the Service or websites linking to the Service. When you leave the Service, you should be aware that these Terms and our policies no longer govern.</p>
...
<p style="font-family:monospace">THE SERVICE AND ANY OTHER SERVICE AND CONTENT INCLUDED ON OR OTHERWISE MADE AVAILABLE TO YOU THROUGH THE SERVICE ARE PROVIDED TO YOU ON AN AS IS OR AS AVAILABLE BASIS WITHOUT ANY REPRESENTATIONS OR WARRANTIES OF ANY KIND. WE DISCLAIM ANY AND ALL WARRANTIES AND REPRESENTATIONS (EXPRESS OR IMPLIED, ORAL OR WRITTEN) WITH RESPECT TO THE SERVICE AND CONTENT INCLUDED ON OR OTHERWISE MADE AVAILABLE TO YOU THROUGH THE SERVICE WHETHER ALLEGED TO ARISE BY OPERATION OF LAW, BY REASON OF CUSTOM OR USAGE IN THE TRADE, BY COURSE OF DEALING OR OTHERWISE.</p>
<p style="font-family:monospace">IN NO EVENT WILL COSPIX.NET BE LIABLE TO YOU OR ANY THIRD PARTY FOR ANY SPECIAL, INDIRECT, INCIDENTAL, EXEMPLARY OR CONSEQUENTIAL DAMAGES OF ANY KIND ARISING OUT OF OR IN CONNECTION WITH THE SERVICE OR ANY OTHER SERVICE AND/OR CONTENT INCLUDED ON OR OTHERWISE MADE AVAILABLE TO YOU THROUGH THE SERVICE, REGARDLESS OF THE FORM OF ACTION, WHETHER IN CONTRACT, TORT, STRICT LIABILITY OR OTHERWISE, EVEN IF WE HAVE BEEN ADVISED OF THE POSSIBILITY OF SUCH DAMAGES OR ARE AWARE OF THE POSSIBILITY OF SUCH DAMAGES. OUR TOTAL LIABILITY FOR ALL CAUSES OF ACTION AND UNDER ALL THEORIES OF LIABILITY WILL BE LIMITED TO THE AMOUNT YOU PAID TO COSPIX.NET. THIS SECTION WILL BE GIVEN FULL EFFECT EVEN IF ANY REMEDY SPECIFIED IN THIS AGREEMENT IS DEEMED TO HAVE FAILED OF ITS ESSENTIAL PURPOSE.</p>
...
<p>We take intellectual property rights seriously. In accordance with the Digital Millennium Copyright Act ("DMCA") and other applicable law, we have adopted a policy of terminating, in appropriate circumstances and, at our sole discretion, access to the service for users who are deemed to be repeat infringers. <a href="[afurl.base]/legal/copyright">[afurl.host][afurl.base]/legal/copyright/</a></p>
</section>
...
<section class="cpn-default">
<h3>Governing Law</h3>
<p>The validity of these Terms and the rights, obligations, and relations of the parties under these Terms will be construed and determined under and in accordance with the laws of the Washington State, without regard to conflicts of law principles.</p>
</section>
...
<section class="cpn-default">
<h3>Jurisdiction</h3>
<p>You expressly agree that exclusive jurisdiction for any dispute with the Service or relating to your use of it, resides in the courts of the Washington State and you further agree and expressly consent to the exercise of personal jurisdiction in the courts of the Washington State located in Tacoma Washington in connection with any such dispute including any claim involving Service. You further agree that you and Service will not commence against the other a class action, class arbitration or other representative action or proceeding.</p>
</section>
...
<p>These Terms constitute the entire agreement between you and Cospix.net regarding the use of the Service, superseding any prior agreements between you and Cospix.net relating to your use of the Service.</p>
</section>
...
<section class="cpn-default">
<h3>Feedback</h3>
<p>Please let us know what you think of the Service, these Terms and, in general, Cospix.net. When you provide us with any feedback, comments or suggestions about the Service, these Terms and, in general, Cospix.net, you irrevocably assign to us all of your right, title and interest in and to your feedback, comments and suggestions.</p>
</section>
...
<p>Questions or comments about the Service may be directed to us at the email address &#97;&#100;&#x6d;&#105;&#110;&#64;&#x63;&#x6f;&#115;&#112;&#x69;&#120;&#x2e;&#x6e;&#x65;&#116;.</p>
</section>
