<article class="cpn-default">
	...
	<div class="cpn-default" style="padding:2px">
		<a id="gallery-item-[g.file_hash;f=hex]" href="[afurl.base]/image/[g.file_hash;f=hex;block=a]?gallery=[g.gallery_id]" class="cpn-thumb-link" data-id="[g.file_hash;f=hex]"><figure>
